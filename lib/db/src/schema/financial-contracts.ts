...
export const financialContractPaymentVersionsTable = pgTable(
  ...
  (t) => [
    ...
    foreignKey({ columns: [t.supersedesId], foreignColumns: [t.id], name: "fin_contract_payment_versions_supersedes_fkey" }),
    ...
    foreignKey({ columns: [t.reviewedById], foreignColumns: [usersTable.id], name: "fin_contract_payment_versions_reviewed_by_fkey" }),
