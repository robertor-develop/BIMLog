...
export const CreateRfiBody = zod.object({
  ...
  costImpactAmount: zod.string().nullable().optional(),
  costImpactReason: zod.string().nullable().optional(),
  scheduleImpact: zod.string().optional(),
  scheduleImpactDays: zod.number().nullable().optional(),
  scheduleImpactReason: zod.string().nullable().optional(),
  distributionList: zod.array(zod.string()).optional(),
  emailDescription: zod.string().optional(),
