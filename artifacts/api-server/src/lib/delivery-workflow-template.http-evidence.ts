...
try {
  ...
  const approved = await call(pmo,`/company/delivery-workflows/${id}/versions/${v1}/approve`,{ expectedRevision: 2 });
  ...
  assert.equal((await call(pmo,`/company/delivery-workflows/${id}/versions/${v2}/approve`,{ expectedRevision: 1 })).status,200);
  ...
  assert.equal((await call(pmo,`/company/delivery-workflows/${id}/versions/${v1}/retire`,{ expectedRevision: 4 })).status,200);
