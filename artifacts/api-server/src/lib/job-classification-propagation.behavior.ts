...
assert.deepEqual(data.scopeItems[0]!.workPackages[0]!.classification, { disciplineId:"7",disciplineCode:"MECH",disciplineName:"Mechanical",serviceId:"",serviceCode:"",serviceName:"",phaseId:"",phaseCode:"",phaseName:"" });
...
assert.match(ui,/Use project discipline/);
assert.match(ui,/Select for this package or task/);
