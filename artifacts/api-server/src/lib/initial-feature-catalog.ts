...
function feature(input: SeedInput): CatalogFeature {
  return {
    id: `${input.key}:1`, featureKey: input.key, version: 1,
    ...
    commercialAuthority: input.commercial ?? "none", preferenceKey: input.preference ?? null,
  };
}

export const INITIAL_FEATURE_CATALOG: readonly CatalogFeature[] = [
  feature({ key: "rfi.core", nameEn: "RFI Core", nameEs: "RFI principal", descriptionEn: "Verified RFI creation, lifecycle, responses, evidence, and audit history.", descriptionEs: "Creación, ciclo de vida, respuestas, evidencia e historial de auditoría de RFI verificados.", family: "project_coordination", module: "rfi" }),
  feature({ key: "rfi.export.pdf", nameEn: "RFI PDF exports", nameEs: "Exportaciones PDF de RFI", descriptionEn: "Verified standard, complete, and audit PDF export paths.", descriptionEs: "Rutas verificadas de exportación PDF estándar, completa y de auditoría.", family: "project_coordination", module: "rfi_exports", dependencies: ["rfi.core"] }),
  feature({ key: "rfi.export.excel", nameEn: "RFI register Excel export", nameEs: "Exportación Excel del registro RFI", descriptionEn: "Verified native RFI register workbook export.", descriptionEs: "Exportación verificada del libro nativo del registro RFI.", family: "project_coordination", module: "rfi_exports", dependencies: ["rfi.core"] }),
  ...
  feature({ key: "telegram.delivery_concierge", nameEn: "Telegram Delivery Concierge", nameEs: "Concierge de entrega por Telegram", descriptionEn: "Verified guided delivery with explicit artifact and recipient confirmation.", descriptionEs: "Entrega guiada verificada con confirmación explícita del artefacto y de los destinatarios.", family: "communications", module: "telegram", externalDelivery: true, confirmations: ["confirm_artifact"], dependencies: ["telegram.linking"] }),
  feature({ key: "navisworks.lens", nameEn: "Navisworks Lens platform", nameEs: "Plataforma Navisworks Lens", descriptionEn: "Verified integrated web-platform viewpoint lineage and reconciliation state; this does not claim plugin field acceptance.", descriptionEs: "Estado verificado e integrado de linaje y conciliación de puntos de vista en la plataforma web; no implica aceptación de campos del complemento.", family: "coordination", module: "navisworks_lens" }),
