...
export const INITIAL_FEATURE_CATALOG: readonly CatalogFeature[] = [
  ...
  feature({ key: "cost_financial_control", nameEn: "Cost & Financial Control", nameEs: "Control de costos y finanzas", descriptionEn: "Operational cost, budget, contract, and commitment controls without accounting posting or payment movement.", descriptionEs: "Controles operativos de costos, presupuestos, contratos y compromisos sin asientos contables ni movimiento de pagos.", family: "cost_financial_control", module: "foundation", status: "coming_later", tiers: ["business", "enterprise"], commercial: "tier_or_addon", contract: "grant_and_restrict" }),
  ...
  feature({ key: "cost.structure.view", nameEn: "Cost structure view", nameEs: "Consulta de estructura de costos", descriptionEn: "Verified read-only company and project cost-structure access.", descriptionEs: "Acceso verificado de solo lectura a estructuras de costos de empresa y proyecto.", family: "cost_financial_control", module: "cost_structure", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.structure.manage", nameEn: "Cost structure management", nameEs: "Gestión de estructura de costos", descriptionEn: "Verified versioned cost-library and project-pinning controls.", descriptionEs: "Controles verificados para bibliotecas versionadas y fijación por proyecto.", family: "cost_financial_control", module: "cost_structure", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.budget.view", nameEn: "Project budget view", nameEs: "Consulta de presupuesto del proyecto", descriptionEn: "Verified operational project-budget access.", descriptionEs: "Acceso verificado al presupuesto operativo del proyecto.", family: "cost_financial_control", module: "budget", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.budget.prepare", nameEn: "Budget preparation", nameEs: "Preparación de presupuesto", descriptionEn: "Verified exact-decimal draft and import workflow.", descriptionEs: "Flujo verificado de borrador e importación con decimales exactos.", family: "cost_financial_control", module: "budget", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.budget.review", nameEn: "Budget review", nameEs: "Revisión de presupuesto", descriptionEn: "Verified maker-checker budget review workflow.", descriptionEs: "Flujo verificado de revisión presupuestaria con separación de funciones.", family: "cost_financial_control", module: "budget", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.budget.approve", nameEn: "Budget approval", nameEs: "Aprobación de presupuesto", descriptionEn: "Verified exact-limit approval and immutable baseline creation.", descriptionEs: "Aprobación verificada con límite exacto y creación de línea base inmutable.", family: "cost_financial_control", module: "budget", companyPolicy: true, projectPolicy: true, confirmations: ["confirm_exact_budget"] }),
  feature({ key: "cost.value_planner.view", nameEn: "Cost & Value Planner view", nameEs: "Consulta de Planificador de Costos y Valor", descriptionEn: "Platform-wide entitled access to project cost and value plans.", descriptionEs: "Acceso habilitado en toda la plataforma a planes de costos y valor del proyecto.", family: "cost_financial_control", module: "cost_value_planner", companyPolicy: true, projectPolicy: false }),
  feature({ key: "cost.value_planner.prepare", nameEn: "Cost & Value Planner preparation", nameEs: "Preparación del Planificador de Costos y Valor", descriptionEn: "Create and preserve cost, value, performance, and bonus plans.", descriptionEs: "Crear y preservar planes de costos, valor, rendimiento y bonos.", family: "cost_financial_control", module: "cost_value_planner", companyPolicy: true, projectPolicy: false }),
  feature({ key: "cost.report.view", nameEn: "Approved baseline view", nameEs: "Consulta de línea base aprobada", descriptionEn: "Verified approved budget snapshot viewing.", descriptionEs: "Consulta verificada de instantáneas de presupuesto aprobadas.", family: "cost_financial_control", module: "budget_reports", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.report.export", nameEn: "Approved baseline export", nameEs: "Exportación de línea base aprobada", descriptionEn: "Verified searchable PDF and native XLSX baseline exports.", descriptionEs: "Exportaciones verificadas de línea base en PDF buscable y XLSX nativo.", family: "cost_financial_control", module: "budget_reports", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.contract.view", nameEn: "Contract register view", nameEs: "Consulta del registro de contratos", descriptionEn: "Record-scoped operational contract access.", descriptionEs: "Acceso operativo a contratos limitado por registro.", family: "cost_financial_control", module: "contracts", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.contract.manage", nameEn: "Contract record administration", nameEs: "Administración de acceso a contratos", descriptionEn: "Versioned internal record-access administration without financial approval inheritance.", descriptionEs: "Administración versionada de acceso interno sin heredar aprobación financiera.", family: "cost_financial_control", module: "contracts", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.commitment.view", nameEn: "Commitment view", nameEs: "Consulta de compromisos", descriptionEn: "Operational commitment and SOV access.", descriptionEs: "Acceso operativo a compromisos y SOV.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.commitment.prepare", nameEn: "Commitment preparation", nameEs: "Preparación de compromisos", descriptionEn: "Exact-decimal contract, SOV, and amendment preparation.", descriptionEs: "Preparación de contratos, SOV y enmiendas con decimales exactos.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.commitment.review", nameEn: "Commitment review", nameEs: "Revisión de compromisos", descriptionEn: "Maker-checker contract and amendment review.", descriptionEs: "Revisión de contratos y enmiendas con separación de funciones.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.commitment.approve", nameEn: "Commitment approval", nameEs: "Aprobación de compromisos", descriptionEn: "Exact scoped approval with controlled budget exceptions.", descriptionEs: "Aprobación exacta por alcance con excepciones presupuestarias controladas.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true, confirmations: ["confirm_exact_commitment", "confirm_over_budget_exception"] }),
  feature({ key: "cost.commitment.execute", nameEn: "Commitment execution attestation", nameEs: "Atestación de ejecución de compromisos", descriptionEn: "Separate signed-evidence execution attestation.", descriptionEs: "Atestación de ejecución separada con evidencia firmada.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true, confirmations: ["confirm_exact_contract_execution"] }),
  feature({ key: "cost.commitment.import", nameEn: "SOV import", nameEs: "Importación de SOV", descriptionEn: "Bounded CSV/XLSX preview and confirmation.", descriptionEs: "Vista previa y confirmación limitada de CSV/XLSX.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true }),
  feature({ key: "cost.commitment.export", nameEn: "Contract export", nameEs: "Exportación de contratos", descriptionEn: "Searchable contract PDF and native XLSX output.", descriptionEs: "PDF buscable y XLSX nativo de contratos.", family: "cost_financial_control", module: "commitments", companyPolicy: true, projectPolicy: true }),
];
