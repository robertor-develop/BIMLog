...
assert.match(navbar, /BIMLOG_RELEASE_VERSION = "v1\.05\.N11-P06"/, "Navbar must expose the current shared BIMLog release");
assert.match(page, /HELP_RELEASE_VERSION = "v1\.05\.N11-P06"/, "Help Center must expose the current shared BIMLog release");
