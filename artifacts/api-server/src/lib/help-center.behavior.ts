...
assert.match(navbar, /BIMLOG_RELEASE_VERSION = "v1\.60\.35\.10-F"/, "Navbar must expose the authorized Feedback operations release");
assert.match(page, /HELP_RELEASE_VERSION = "v1\.60\.35\.10-F"/, "Help Center must expose the authorized Feedback operations release");
