...
assert.match(navbar, /BIMLOG_RELEASE_VERSION = "v1\.05\.N12-P09"/, "Navbar must expose the current Platform release");
assert.match(page, /HELP_RELEASE_VERSION = "v1\.05\.N12-P09"/, "Help Center must expose the current Platform release");
