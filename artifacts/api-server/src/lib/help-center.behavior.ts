...
assert.match(navbar, /BIMLOG_RELEASE_VERSION = "v1\.05\.N17-P26"/, "Navbar must expose the current Platform release");
assert.match(page, /HELP_RELEASE_VERSION = "v1\.05\.N17-P26"/, "Help Center must expose the current Platform release");
