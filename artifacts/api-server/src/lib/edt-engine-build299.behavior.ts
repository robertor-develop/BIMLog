...
assert.match(route,/pool!=="direct_production"&&pool!=="project_administrative"/);assert.match(service,/authorize\(input\.actor,"JOB_OPERATE",input\.companyId,input\.projectId\)/);
