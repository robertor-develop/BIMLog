...
const item:EdtPlanWorkItem={id:"w1",edtNodeSourceIdentity:"L1",contractSourceIdentity:"c",locationIdentity:"L1",locationSnapshot:{},tradeIdentity:"HVAC",tradeSnapshot:{},deliverableTypeIdentity:"d",deliverableTypeSnapshot:{},displayCode:makeEdtWorkItemCode({project:nodes[0],contract:nodes[1],deliverable:nodes[2],location:nodes[3],tradeIdentity:"HVAC"})};
