...
const item:EdtPlanWorkItem={id:"w1",edtNodeSourceIdentity:"L1",locationIdentity:"L1",locationSnapshot:{},tradeIdentity:"HVAC",tradeSnapshot:{},deliverableTypeIdentity:"MODEL",deliverableTypeSnapshot:{},displayCode:"P-HVAC-L1"};
