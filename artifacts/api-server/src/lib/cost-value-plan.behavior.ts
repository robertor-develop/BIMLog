...
assert.match(plannerWorkspace, /Use complete BIM sample/);
assert.match(plannerWorkspace, /PrintPdfButton/);
assert.doesNotMatch(plannerWorkspace, /window\.print|Print \/ Save draft PDF|Draft PDF/);
assert.match(plannerWorkspace, /Export CSV/);
assert.match(plannerWorkspace, /data-testid="cost-value-guide"/);
assert.match(plannerWorkspace, /data-testid="cost-value-save-readiness"/);
assert.match(plannerWorkspace, /Complete remainder/);
assert.match(plannerWorkspace, /Split equally/);
assert.match(plannerWorkspace, /completeLineRemainder/);
