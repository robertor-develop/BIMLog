...
function objectValue(value:unknown,field:string):Record<string,unknown>{if(value==null)return {};if(typeof value!=="object"||Array.isArray(value)||JSON.stringify(value).length>16000)throw new CoordinationKnowledgeContractError("RESOLUTION_EVIDENCE_INVALID",field);return value as Record<string,unknown>;}
