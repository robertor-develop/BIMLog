...
async function runAdmin() {
  ...
  await page.getByText("FB-OPS801").waitFor();check(sid,"ticket metadata is immediately visible while evidence is quarantined",await page.getByText("1 clean · 1 awaiting scan · 0 rejected").count()===1);
