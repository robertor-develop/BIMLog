...
type View = "overview" | "planner" | "evidence" | "schedule";
...
export function TeamPerformanceWorkspace() {
  ...
  return <FinancialProjectShell projectId={projectId} activeTab="team-performance">
    ...
    <div className="tp">
      ...
      {view === "schedule" && <ResourceSchedulingPanel projectId={projectId} token={token} lang={lang} actorUserId={Number(user?.id ?? 0)}/>}
    </div>
