...
const SECTIONS = [
  ...
  },
  {
    ...
    description: "BIMLog connects with the tools your team already uses. Your data always goes with you.",
    features: [
      "Direct integrations — Procore, Autodesk ACC, OneDrive, SharePoint (Business and above)",
      "MS Project schedule import (Business and above)",
      "Export to Excel — RFI log, Submittal log",
      "Export to Word and PDF — individual RFIs and Submittals",
      "Audit Certificate PDF export",
      "Full API access with webhooks (Enterprise)",
      "PowerBI connector (Business and above)",
