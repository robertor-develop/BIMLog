...
const PRO_FEATURES = [
  ...
  "Audit Certificate PDF — structured, UUID identified, tamper-evident",
...
const BUSINESS_FEATURES = [
  ...
  "Contracted service levels when included in the customer agreement",
];
...
const ENTERPRISE_FEATURES = [
  ...
  "Custom service levels defined in the customer agreement",
  "Bulk seat pricing",
...
const PRICING_ES_COPY: Record<string, string> = {
  ...
  "Audit Certificate PDF — structured, UUID identified, tamper-evident": "PDF de Certificado de Auditoría — estructurado, identificado por UUID y con evidencia de alteraciones",
  "Contracted service levels when included in the customer agreement": "Niveles de servicio contratados cuando estén incluidos en el acuerdo del cliente",
  "Custom service levels defined in the customer agreement": "Niveles de servicio personalizados definidos en el acuerdo del cliente",
