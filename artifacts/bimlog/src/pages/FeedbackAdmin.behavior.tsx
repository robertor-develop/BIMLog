...
const checks: Array<[string, RegExp]> = [
  ...
  ["owned reviewer surface shows the requested release label", /v1\.60\.35\.12-F/],
  ...
  ["operations distinguish independent encrypted backup and exact restore truth", /Independent encrypted backup.*operations\.backup\?\.configured.*AES-256-GCM.*exact restore verified before settlement.*operations\.backup\.manualReview/s],
