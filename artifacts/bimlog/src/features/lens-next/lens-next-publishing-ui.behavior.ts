...
check(view.includes('activeIssueCount === 1 ? tt("issue", "incidencia") : tt("issues", "incidencias")') && view.includes('{synchronizationPlan.items.length === 1 ? "item" : "items"}'), "issue and synchronization-plan counts use correct singular grammar");
