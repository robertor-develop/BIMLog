...
const issue={identity:{serverId:7,projectId:1,viewpointId:"VIEW-Á01",revisionNumber:1,lifecycleStatus:"active",supersedesId:null},displayId:"CL-007",note:"Duct conflict",openItems:null,trade:"HVAC",floor:"Level 02",responsibleCompany:"BIMTech",reportType:"Coordination",status:"open",priority:1} as unknown as LensNextIssue;
