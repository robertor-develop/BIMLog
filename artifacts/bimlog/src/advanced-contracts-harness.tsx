...
createRoot(document.getElementById("root")!).render(<main className="fc-page"><style>{financialContractWorkspaceStyles}</style><ContractPaymentApplicationsPanel projectId={77} contract={{id:"contract-77",currency:"USD",status:"executed"}} lines={sov} token="isolated-ui-token" language={language} tt={tt}/></main>);
