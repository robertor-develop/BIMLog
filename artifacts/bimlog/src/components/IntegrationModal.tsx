    ...
    <>
      {[
        ...
        },
        {
          ...
          desc: "Secure token-based direct integration. Log in through your existing platform credentials. No manual setup. No API tokens to manage. Available on Business plans and up.",
          buttonLabel: "Get Started",
