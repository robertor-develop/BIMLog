...
$manifest=[ordered]@{schemaVersion='bimlog-lens-next-package-v1';product='BIMLog Lens Next';productYear=$year;release=$Version;binaryVersion=$binaryVersion;installBundle=$bundleName;installTarget="C:\ProgramData\Autodesk\ApplicationPlugins\$bundleName";originalLensPreserved=$false;legacyLensRetirementPolicy='preserve-hash-verified-evidence-outside-load-root-then-remove';files=$manifestFiles}
