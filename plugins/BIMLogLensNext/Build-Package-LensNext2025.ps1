[CmdletBinding()]
param([string]$Version = 'v1.05.N17-P10')
$ErrorActionPreference = 'Stop'
$binaryVersion = '1.5.17.10'
if ($Version -ne 'v1.05.N17-P10') { throw 'STOP: stale or unexpected release requested.' }
$year = 2025
