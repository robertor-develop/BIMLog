...
- The exact current committed source/harness candidate is `bc3818b10fa383eb5e1a7d5982c0cd690d9cdf1a` with tree `73151f1167ffaf8aa8fe0926544a6a87914032c3`. Browser-provenance harness commits `db80ffb27c725769781c0b39ef428fc67d972264` and `f79d3831e673d7d4503b13823b406e55b7bf6213` are preserved in its ancestry. The candidate preserves the existing authenticated Feedback widget and route and the exact release identity `v F-1.60.35.8`; it does not create another feedback surface.
...
- The earlier browser package at `75efb36c373f50ec541cb4e5961afd54cfc7db95` and manifest SHA-256 `763360ca19ec33cb277267bea372b6cf67dce944f39c7d371074e4d54da3eca8` are historical, nonaccepting evidence because later provenance corrections changed the harness. The final integrated browser reseal against the exact current candidate remains pending. Any successor remains controlled mocked API/media evidence unless it explicitly proves a live backend boundary.
- At integrated source `b91448a2a16fd06377e7450c2eb40c745c9629ee`, the immutable API/database receipt SHA-256 `39fc08553165251d94ef70af5c9590213c369f95b4ce82611eb4e9e6aa95862a` accepted dynamic disposable-PostgreSQL behavior 99/99, source/receiver behavior 215/215, API/UI/full-workspace typechecks, secret and mojibake scans, diff check, and zero residue. That receipt was blocked from final readiness by the then-open database-safety findings.
- Successor `bc3818b10fa383eb5e1a7d5982c0cd690d9cdf1a` adds the missing purge-command and purge-key-authority Drizzle declarations and the narrow governed DROP safety classifications. Database safety, relevant typechecks, and the 53/53 relay migration source suite pass at this successor. The 99/99 dynamic database suite was not rerun after this schema-safety change, so exact-head API/database acceptance remains pending.
...
- This is committed local source evidence only. It is not pushed, available in Replit, published, deployed, production-migrated, provider-activated, independently release-accepted, or customer-verified. Source push and Replit publication remain separate explicit phases.
