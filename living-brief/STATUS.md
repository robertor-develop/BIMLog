...
- The isolated loopback PostgreSQL and HTTP proof passes 13/13 for concurrent identical replay, divergent conflict, cross-company and suspended denial, single record/audit custody, quarantine, download refusal, and duplicate-hash zero-row-growth behavior. Production/provider activation remains outside this proof.
