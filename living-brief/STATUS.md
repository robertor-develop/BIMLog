...
- Replit Nix source includes ClamAV and signature-authority successor `5de30cc8e36098f2929754836abdfcbf89ee73b9` binds a committed direct launcher at `/home/runner/workspace/artifacts/api-server/scripts/feedback-clamav-replit.sh`, launcher SHA-256 `294b420762f6dff735f482b908da5037c49e8cbb0e99c3d10e97d65f1084b0f6`, exact content-addressed `clamscan` and `freshclam` paths under `/nix/store/j01wsla7rfrgjv3605l561mni4b4ka05-clamav-1.4.3`, version `ClamAV 1.4.3`, and committed FreshClam configuration SHA-256 `ea4c360a6114a60aba9bf56ec7b0a264bc03baf55e4e3955fa2de4830921c78c`. Startup now fails closed until Cisco Talos signature databases are downloaded by FreshClam, verified as bounded regular no-link files, loaded successfully by the exact scanner, and marked ready. A private lock serializes initialization/refresh, stale signatures fail closed after 48 hours, and the scanner receives 120-second bounded startup/scan deadlines. The launcher accepts only the fixed version or stdin-scan operation, and the production adapter hashes the direct launcher before and after every operation. Exact Replit database download, clean/infected execution, deployment promotion, and automatic evidence backfill remain pending. Existing ticket metadata remains reviewable while attachment bytes stay quarantined. The scan worker alone may promote exact bytes to clean and trigger regenerated packages; manual database promotion is prohibited.
