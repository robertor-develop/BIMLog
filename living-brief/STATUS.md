...
- The isolated loopback PostgreSQL and HTTP proof passes 16/16 for audit-failure rollback, concurrent identical replay, divergent conflict, cross-company and suspended denial, single record/audit custody, quarantine, download refusal, duplicate-hash zero-row-growth, and physical storage residue behavior. Production/provider activation remains outside this proof.
