...
- Replit schema-sync correction `c13263d0b5decd48fc9b49118a48ad241b5f8476` replaces the Drizzle BigInt JavaScript default with an equivalent SQL literal and makes the development-sync wrapper reject uncaught JavaScript tool errors. The first publication preview was cancelled before approval because it proposed dropping governed Feedback constraints; no production migration ran. The correction must produce a clean development sync and a non-destructive publication preview before approval.
