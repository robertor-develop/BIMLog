...
- Local Builds 16–20 clarify the separate PMO independent-checker and Finance denial for company Governance Policy approval, expose company-scoped review actor/version timestamps, and give bilingual lifecycle guidance and readable audit history in Headquarters. This is a lifecycle usability and evidence correction, not enforcement of configured approval thresholds, change rules or company-role rows. Publication, live Chrome acceptance and full end-to-end Template/Intake/EDT proof remain separate until the exact block passes its release gates.
