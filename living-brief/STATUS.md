...
- Local Builds 26–30 reuse one canonical published-policy query across Intake and activation, deny publishing a company Delivery Workflow that violates its applicable published Governance Policy, prove positive and negative publication through isolated localhost PostgreSQL/HTTP, give bilingual corrective guidance, and serialize policy retirement with the same company-scoped publication lock. A denied publish leaves the preceding version published and the candidate approved. No new schema, Native, installer, or customer data was changed. The ten-build push, Replit publication and authenticated Chrome smoke are due only after the exact-head gate; configured approval/change/permission matrices remain policy intent, not complete runtime grants.
