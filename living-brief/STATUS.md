...
- No installation or live acceptance occurred. Navisworks Manage 2021 is installed on this host; Manage 2025 is absent. The package installer targets `C:\ProgramData\Autodesk\ApplicationPlugins\BIMLogLensNext2021.bundle`, which is outside the Constitution 3.3.0 exact C-root Navisworks exception, so live 2021 installation and acceptance require a separate exact constitutional authorization/amendment. Live 2025 acceptance remains pending an installed 2025 host after that gate.
