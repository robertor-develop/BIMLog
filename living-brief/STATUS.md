...
- Builds 41–45 are a local candidate for narrow, assignable EDT Operations Director authority: append-only company/project/user grant and revocation records, current same-company active-membership checks, Super Administrator-only grant management, and role resolution that does not add EDT approval to CEO, PMO or Project Leader. Governed EDT activation mutations remain closed until this role path and positive canonical Contract source are verified against real isolated PostgreSQL and a separate authorized reviewer. This candidate has not yet been pushed or published.
