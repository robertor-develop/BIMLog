...
- The exact frozen local source-and-harness candidate is `344a0ba7c6dabc0d38c7c8dabf7cbf7646b47458` with governed PDF parent `d575b81cc5190affff33afcb5e52b6196a2d8880`, nested-modal source correction `dd903406`, and release identity `v1.60.35.09-F`. It preserves the governed package/register/notification scope and exposes the nested markup dialog outside the hidden parent modal while retaining accessible labeling.
