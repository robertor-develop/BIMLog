...
- Replit schema-sync corrections `c13263d0b5decd48fc9b49118a48ad241b5f8476`, `e5458c4c14ff10cfada8df2ec10672127666e336`, and exact-definition proof `d2baedb3a26686f6533d0d116add4dd048325670` replace the Drizzle BigInt JavaScript default with an equivalent SQL literal, reject uncaught JavaScript tool errors, and bind every governed Feedback foreign-key/expiry constraint under its exact production name and PostgreSQL definition. Two publication previews were cancelled before approval because they proposed dropping governed Feedback constraints; no production migration ran. The strengthened development parity gate now refuses any missing, renamed, or definition-drifted governed Feedback constraint, and publication approval still requires a preview with no destructive Feedback SQL.
