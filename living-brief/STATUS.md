...
- The exact current committed source/harness candidate is `17353d45274f36130cadc47c0515a4dbf5ada71b`; its final API/database receipt is pending. The browser-tested ancestor is `75efb36c373f50ec541cb4e5961afd54cfc7db95`. Both preserve the existing authenticated Feedback widget and route and the exact release identity `v F-1.60.35.8`; neither creates another feedback surface.
...
- Browser provenance corrections `bec5b3edda8b6d378a89765ebe192440e818ef3d` and `f48250e0709eb6bab9128ec513b46f460791a3d7` bind the harness and 229 production inputs to immutable Git objects. The final browser manifest at `75efb36c373f50ec541cb4e5961afd54cfc7db95` has SHA-256 `763360ca19ec33cb277267bea372b6cf67dce944f39c7d371074e4d54da3eca8` and reports 56/56 assertions, four screenshots, and zero leaks/errors across the actual production `App` and `FeedbackWidget` in Chrome at English 1440x900 and Spanish 390x844. This is controlled mocked API/media evidence: it uses no live API, database, scanner, transcription provider, receiver, Replit, customer, or production system.
- `ensureFeedbackSchema` remains the sole additive runtime Feedback migration authority. Its relay schema proof is isolated localhost evidence and does not authorize production migration. The final exact-current API/database acceptance receipt for the post-browser candidate is still pending from the separate acceptance owner.
