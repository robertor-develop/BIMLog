...
- Builds 36–40 serialize workflow and policy approval with company policy publication, reject incompatible published workflows and overlapping scope at Governance review, and explain compatibility failures in the bilingual editor. Publication-time checks still revalidate against changes after approval. The isolated workflow and Governance HTTP suites passed against a disposable localhost database. The generated Platform authority inventory was reconciled after implementation. The complete exact-head gate, push, Replit publication and authenticated Chrome smoke are separate release gates. Approval thresholds, company-role grants, other change rules and positive six-role EDT acceptance are still open; this block does not claim customer acceptance.
