...
- Replit Nix source includes ClamAV and configuration successor `2e114c90ae2366e269fd78bd5952bb1b48154e38` binds the visible-Shell verified executable `/nix/store/j0lwsla7rfrgjv3605l561mni4b4ka05-clamav-1.4.3/bin/clamscan`, SHA-256 `35b10511e5136c8421274df82db4a7ce993de8935d914346ea84513d4e69ccc6`, and version `ClamAV 1.4.3` into tracked non-secret Replit configuration. Production activation remains fail-closed until the exact clean successor publishes and startup re-verifies that identity. Existing ticket metadata remains reviewable while attachment bytes stay quarantined. The scan worker alone may promote exact bytes to clean and trigger regenerated packages; manual database promotion is prohibited.
...
- Focused API/UI typechecks and Feedback evidence/storage/package/follow-up, Telegram worker, route authority, reviewer UI, notification-panel, and customer widget suites pass for the exact product commit. Source push, Replit synchronization, scanner configuration, publication, live verification, Telegram delivery, and permanent receiver activation remain separate external gates.
