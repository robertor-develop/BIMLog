...
- The first Block 13 full gate found the new endpoint absent from the tracked route graph. The graph was deterministically regenerated to 660 API routes and its exact regression test passed; the full gate must still be rerun before push.
