...
- The exact current committed startup candidate is `9e428f3cb249d5b80041ee5f19ded9cfe962d141` with tree `d35e621fede9c4969d53b6b75de4b3aed74e4f38`. Commits `74b7a6e0f5ed27959c799443911d5645168bc8e9` and `9e428f3cb249d5b80041ee5f19ded9cfe962d141` make invalid production Feedback storage authority fail before the listener and bind that behavior into the production entrypoint. Artifact-harness commits `1ac8c8a3bc03f7e396926c0339c3c4fb054f5a7a` and `962561c3e1ed028260355b5e76409c60dde55cee`, plus browser-provenance commits `db80ffb27c725769781c0b39ef428fc67d972264` and `f79d3831e673d7d4503b13823b406e55b7bf6213`, remain in ancestry. The candidate preserves the existing authenticated Feedback widget and route and exact release identity `v F-1.60.35.8`; it does not create another feedback surface.
...
- The integrated browser reseal at `f3784fc89f17f2ddd9dda05df6df13e00959e44b`, tree `bb9caa7a977e8dc7bffffc7cf427f1c2e8de0bcb`, and manifest SHA-256 `a885fb1ae634427085ea802ea7d40261a24f808afff583d40fc0dd3635a0e67d` remains accepted predecessor product evidence: all 229 production-input hashes were identical and 56/56 actual-component assertions passed in the isolated controlled-mock browser boundary. Because later artifact-harness and startup commits advanced the exact identity, a final browser reseal at `9e428f3cb249d5b80041ee5f19ded9cfe962d141` remains pending.
...
- Startup behavior, API/full-workspace typechecks, database-safety source and fixtures, tracked-secret, mojibake, production runtime-closure build, and standalone production artifact pass at `9e428f3cb249d5b80041ee5f19ded9cfe962d141`. The full workspace build remains pending only until this Living Brief reconciliation is committed and rerun. This is local source evidence only: it is not pushed, available in Replit, published, deployed, production-migrated, provider-activated, independently release-accepted, or customer-verified. Source push and Replit publication remain separate explicit phases.
