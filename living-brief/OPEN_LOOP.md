...
- Complete exact clean build, source push, Replit synchronization, and live browser verification for entry-point hotfix `7fbcb3ec0978b3529ec67c27fa8063b62d108caa`: plain `/feedback` and the floating button must open **New feedback**; only `/feedback?view=mine` notification links may open **My feedback**. Preserve direct tab switching and prove repeated close/reopen cannot retain the history tab unintentionally.
