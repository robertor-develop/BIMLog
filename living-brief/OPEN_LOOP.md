...
- Preserve the tracked Replit ClamAV binding at `2e114c90ae2366e269fd78bd5952bb1b48154e38`: visible-Shell executable `/nix/store/j0lwsla7rfrgjv3605l561mni4b4ka05-clamav-1.4.3/bin/clamscan`, SHA-256 `35b10511e5136c8421274df82db4a7ce993de8935d914346ea84513d4e69ccc6`, and version `ClamAV 1.4.3`. Require clean synchronized source, deployment startup health, an exact clean/infected/failure scan receipt, and automatic backfill of existing quarantined evidence before claiming attachments are available in PDF/Word/ZIP. Never mark attachment rows clean manually.
