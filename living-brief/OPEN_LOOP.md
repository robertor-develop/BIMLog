...
- [ ] Release-verify the local Builds 6–10 Intake correction: Quick Start now offers only project Discipline; generic activation tasks no longer inherit project-wide Service/Phase; older saved drafts expose their retained legacy values in Quick and Advanced with an explicit clear action; Client/floor guidance states project/contract versus package/task authority. Focused source/behavior tests pass. The live site and rejected PDF have not yet been updated or retested.
