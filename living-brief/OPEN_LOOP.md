...
- [ ] Block 03 Builds 011–015: run the exact full gate and focused Navisworks 2021/2025 package/test smoke, then push the clean head normally. No install or publication is due at Build 015.
...
- [ ] Build 020: pass the exact clean full gate, push the block head, run the read-only publication database operator in Replit Shell, publish once with development-data copy off, and pass exact-identity authenticated visible-Chrome smoke plus restart/session restoration. Replit Agents remain prohibited.
