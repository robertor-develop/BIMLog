...
- [ ] Complete and field-prove company Delivery Workflow and Governance authoring, independent approval, publication, activation, versioning, supersession and audit. Builds 11–30 reached GitHub and were published through Build 30 at `4487fa5d98bf1479eb68e24769113ce45679fe78`; authenticated Chrome covered a limited Governance/Intake regression, not the six-role end-to-end path. Builds 31–35 reached GitHub at `c9995eaccf30a19ac8847c8c0141bf83eb774ad7` without publication. Builds 36–40 add approval-time company-lock serialization, reject incompatible or overlapping Governance drafts before approval, explain the denials in the bilingual editor, and reconcile the generated Platform contract; isolated workflow and Governance HTTP suites passed. The Build 40 complete gate, exact push, Replit publication and full authenticated Chrome smoke remain release gates. Approval thresholds, company-role rows and other change rules remain intent rather than full execution authority; guarded EDT mutations remain closed.
