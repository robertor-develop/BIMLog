...
- The prior frozen `344a0ba7c6dabc0d38c7c8dabf7cbf7646b47458` package/browser candidate remains predecessor evidence only. Preserve exact local operational-intake product head `78374d8bfeb4b41c722a55bd7a3d01cc00fcebdd`, tree `62905016ecdcbc899861b67172de7a46f195e00f`: valid reviewer/customer deep links, the super-admin-only review queue, owner/package/evidence/follow-up/response controls, post-commit notification delivery with idempotent reconciliation, customer DTO privacy, and governed ClamAV scanner/worker source. It is not pushed, synchronized to Replit, published, production-migrated, scanner/receiver/provider activated, live verified, or customer accepted.
- Complete exact clean build, source push, Replit synchronization, and live browser verification for reactive-query successor `e9fcee4604669cb2f3b313c038d9b386a943660c`: plain `/feedback` and the floating button must open **New feedback**; `/feedback?view=mine` notification links must persistently open **My feedback**; direct tab switching must remain available; repeated close/reopen must not retain the history tab unintentionally. Predecessor `c73a82f7b2552bd380c99d2748ecea4c568bde64` is published and live for the default-new correction but does not satisfy the direct-query history gate.
