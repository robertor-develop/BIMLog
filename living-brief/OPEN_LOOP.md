...
- [ ] Complete and field-prove company Delivery Workflow and Governance authoring, independent approval, publication, activation, versioning, supersession and audit. Builds 11–30 reached GitHub and were published through Build 30 at `4487fa5d98bf1479eb68e24769113ce45679fe78`; authenticated Chrome covered a limited Governance/Intake regression, not the six-role end-to-end path. Builds 31–35 add scoped published-workflow compatibility before policy publication, policy validation at workflow approval, and the explicit prohibition on governed version retirement. Approval thresholds, company-role rows and other change rules remain intent rather than full execution authority; guarded EDT mutations remain closed. Build 35 is push-only; publication and full authenticated Chrome smoke are due at Build 40.
