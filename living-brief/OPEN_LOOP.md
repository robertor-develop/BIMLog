...
- [ ] Blocks 9–10, Builds 41–50: finish exact clash-data linkage, remaining imagery parity, performance and full live/Native acceptance. Bounded 3D does not displace these obligations. Block 8 is only a local review-surface candidate, not an accepted synchronization release.
