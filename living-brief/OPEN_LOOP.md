...
- Preserve the Replit-proven launcher binding at `d0d8d7bb9ba5939ede74edd2e5f84c1ea8104aae`: direct committed launcher `/home/runner/workspace/artifacts/api-server/scripts/feedback-clamav-replit.sh`, launcher SHA-256 `2e98606a41feb0d24de65dacadf443f270db775e526ab1b9a671bf23baeb00bc`, exact declared Nix scanner `/nix/store/j01wsla7rfrgjv3605l561mni4b4ka05-clamav-1.4.3/bin/clamscan`, and version `ClamAV 1.4.3`. Exact Replit Shell startup verification passes. Still require clean synchronized deployment startup health, an exact clean/infected/failure scan receipt, and automatic backfill of existing quarantined evidence before claiming attachments are available in PDF/Word/ZIP. Never mark attachment rows clean manually.
