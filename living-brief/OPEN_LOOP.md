...
- `INTAKE-APU-09` adds the contextual help, hierarchy explanation, approval boundaries, keyboard
  ...
  integration, authorized persistence proof, and external acceptance. Build 10 must complete
  compatibility, migration preview, whole-scenario validation, and release acceptance without
  publishing or mutating production under this local-build authority.
...
- `INTAKE-APU-07` implements work-package-owned resource planning at `v1.05.N01-P07`, including
  ...
  exact-clean full workspace build, integration, authorized API/database autosave/reload proof,
  and external release/acceptance. Build 08 must assemble the Job Command Center from these existing
  Intake, agreement, APU, package, resource, schedule, task, and document authorities.
...
- `INTAKE-APU-05` implements the local multiple-APU builder at `v1.05.N01-P05` using editable
  ...
  API/database autosave/reload proof, and external release/acceptance. Build 06 must add
  floor/zone/task/deliverable work-package decomposition under these APU identities without
  creating another schedule or document authority.
...
- `INTAKE-APU-04` implements the local agreement-lifecycle board at `v1.05.N01-P04`.
  ...
  Build 05 now attaches multiple APU drafts and immutable canonical-version links to their owning
  agreement without duplicating pricing, budget, or approved-baseline authority.
