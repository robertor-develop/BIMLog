...
- [ ] Block 10, Builds 46–50: Builds 46–49 have a local integration candidate (compact bilingual header, no short-window list/pagination overlap, 37/37 Lens Next behavior files, typecheck, bundle, desktop geometry and exact-390 containment). Build 50 remains open: pixel visual review, exact project/model-bound real clash-data linkage, actual bounded 3D imagery, Native 2021/2025 field runs, authenticated/live Chrome and customer acceptance. No screenshot, synthetic image, title similarity or fixture may close that gate. Blocks 5–10 are local candidates, not a published accepted release.
