...
assert.equal(inventory.currentAuthority.uncheckedItems.length, 1, "current authority preserves only Ruben's deferred 2025 field evidence after Platform and 2021 closure");
