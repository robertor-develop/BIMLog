...
assert.equal(inventory.currentAuthority.heading, "Current open-loop authority — Coordination Knowledge Library Block 5 — 2026-09-21");
...
assert.ok(currentItems.some(item => item.statement.includes("Builds 251–255")), "the next Coordination Knowledge block remains explicit");
