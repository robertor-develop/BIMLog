...
assert.equal(inventory.currentAuthority.heading, "Current open-loop authority — post-120 Block 42 — 2026-09-21");
assert.equal(inventory.currentAuthority.uncheckedItems.length, 3, "current authority preserves Build 210 publication plus physical 2021 remediation and deferred 2025 field evidence");
