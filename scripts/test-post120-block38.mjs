...
assert.equal(inventory.currentAuthority.heading, "Current open-loop authority — Coordination Knowledge Library Block 7 — 2026-09-22");
...
assert.ok(currentItems.some(item => item.statement.includes("Builds 261–264")), "the next Coordination Knowledge product block remains explicit");
