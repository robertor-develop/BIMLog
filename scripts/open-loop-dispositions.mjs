...
if (process.argv.includes("--write")) {
  ...
  if (result.currentAuthority.uncheckedItems.length !== 2) throw new Error("The marked current authority must own exactly the active release and field-evidence loops");
