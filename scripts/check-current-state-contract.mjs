...
function validate(snapshot) {
  ...
  assert(ledger.status.completedBuilds === 25 && ledger.status.remainingBuilds === 95, "Build ledger must close Build 025 exactly");
  assert(ledger.status.currentUnpublishedBuilds === 5 && ledger.status.nextBuild === 26, "Build ledger cadence must advance to Build 026 with five unpublished builds");
  assert(ledger.status.nextPushAfterBuild === 30 && ledger.status.nextPublicationAfterBuild === 30, "Build 030 must be the next push/publication milestone");
