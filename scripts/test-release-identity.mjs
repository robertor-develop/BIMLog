...
assert.equal(identity.label, "v1.05.N18-P34");
assert.equal(identity.binaryVersion, "1.5.18.34");
...
assert.throws(() => validateReleaseIdentity({ ...identity, release: { ...identity.release, platform: 35 } }), /label mismatch/i);
